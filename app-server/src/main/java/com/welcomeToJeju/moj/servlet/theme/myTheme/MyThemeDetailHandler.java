...
public class MyThemeDetailHandler implements Command {
  ...
  public void execute(CommandRequest request) throws Exception {
    ...
    no = 1;
    for (String key : controlMenu.keySet()) {
      System.out.printf("<%d> %s ", no++, key);
    }
